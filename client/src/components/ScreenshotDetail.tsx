...
export default function ScreenshotDetail({ imageUrl, title }: ScreenshotDetailProps) {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="flex items-center space-x-2">
          <Button 
            variant="outline" 
            size="icon" 
            className="h-8 w-8 bg-white/50 backdrop-blur-sm border-white/30 text-blue-700 hover:bg-white/70" 
          ...
          <span className="text-xs text-blue-700 bg-blue-100/50 px-2 py-0.5 rounded-md">{Math.round(zoom * 100)}%</span>
          <Button 
            variant="outline" 
            size="icon" 
            className="h-8 w-8 bg-white/50 backdrop-blur-sm border-white/30 text-blue-700 hover:bg-white/70" 
      ...
      <div className="overflow-auto bg-white/30 backdrop-blur-sm border border-white/40 rounded-lg shadow-inner flex items-center justify-center" style={{ minHeight: '400px' }}>
